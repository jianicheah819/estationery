...
public class AddProducts extends HttpServlet {
    ...
    private final String UPLOAD_DIRECTORY = "C:\\Users\\HP\\Downloads\\OnlineShoppingSystem\\build\\web\\assets\\img";
            ...
            try {
                ...
                for (FileItem item : multiparts) {
                    if (!item.isFormField()) {
                        ...
                        FileItem fstatus = (FileItem) multiparts.get(3);
                        status = fstatus.getString();

                        FileItem pcategory = (FileItem) multiparts.get(4);
                ...
                try {
                    ...
                    int i = DatabaseConnection.insertUpdateFromSqlQuery("insert into tblproduct(id,active,code,description,image,image_name,name,price,product_category) values('" + id + "','" + status + "','" + code + "','" + descrip + "','" + imagePath + "','" + imageName + "','" + productName + "','" + productPrice + "','" + category + "')");
