                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <%
                                            ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tblproduct ORDER BY create_date DESC");
                                            while (rs.next()) {
                                        %>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><image src="C:/Users/HP/Downloads/OnlineShoppingSystem/web/assets/img/<%=rs.getString("image_name")%>"
