                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    ...
                                    <img src="C:/Users/HP/Downloads/OnlineShoppingSystem/web/assets/img/<%=retriveProduct.getString("image_name")%>" alt="" class="pro-image-front">
                                    <img src="C:/Users/HP/Downloads/OnlineShoppingSystem/web/assets/img/<%=retriveProduct.getString("image_name")%>" alt="" class="pro-image-back"> <span class="product-new-top">New</span>
                                </div>
