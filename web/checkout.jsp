            ...
            <div class="container">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <%
                            ResultSet totalProduct = DatabaseConnection.getResultFromSqlQuery("select tblproduct.image_name,tblproduct.name,tblcart.quantity,tblcart.discount_price,tblcart.total_price,tblcart.product_id from tblproduct,tblcart where tblproduct.id=tblcart.product_id and customer_id='"
                        ...
                        <tr class="rem1">
                            ...
                            <td class="invert"><img
                                    src="C:/Users/HP/Downloads/OnlineShoppingSystem/web/assets/img/<%=totalProduct.getString(1)%>" alt=""
                                    class="pro-image-front" style="width: 200px; height: 250px;"><br><%=totalProduct.getString(2)%></td>
                            <td class="invert">
                                <div class="quantity">
                            ...
                            <td class="invert">RM <%=totalProduct.getString(4)%>&nbsp;</td>
                            <td class="invert">RM <%=totalProduct.getString(5)%>&nbsp;</td>
                            <td class="invert"><a
                        ...
                        <tr>
                            ...
                            <td colspan="2"><strong><center>
                                        Total Amount:RM &nbsp;<%=finalBill%></center></strong>
                            </td>
                        </tr>
                        <script>
                ...
                <form action="GetProductsOrder" method="post">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <label>Pos Code</label> <input type="text" name="pincode"
