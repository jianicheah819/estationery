                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <%
                                            ...
                                            ResultSet resultOrders = DatabaseConnection.getResultFromSqlQuery("select * from tblorders where order_status='Deliver' ORDER BY order_no DESC");
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img src="C:/Users/HP/Downloads/OnlineShoppingSystem/web/assets/img/<%=resultOrders.getString(9)%>"
